...
// Ajusta este tipo a lo que tengas; necesita estas props mínimas
...
export default function ProductCard({
  ...
  const src = safeImageUrl(product.primary_image_url); // ← blindaje

  const href = `/${lang}/product/${product.slug}`;

  return (
    <div className="rounded-3xl overflow-hidden border border-neutral-200 bg-white">
